...
import dataset as D
from model.sample_level import SampleLevelFeatureExtractorNN
...
def parseArgs():
    ...
    parser.add_argument(
        ...
        default="outputs/samplelevel2img-samples",
    )
    parser.add_argument(
        "--skip_grid",
        action="store_true",
    ...
    parser.add_argument(
        "--sampleckpt",
        type=str,
        default="/home/choi/BrainDecoder/lightning_logs/SampleLevelFeatureExtraction/2024-02-02 10:34:21/version/checkpoints/epoch=992_val_loss=0.0229.ckpt",
    )
